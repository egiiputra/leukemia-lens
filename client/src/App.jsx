    ...
    <div className="container">
        ...
        <div className="main-content">
            <div className="mode-selector">
                <button className="mode-btn active" onclick="switchMode('single')">Single Inference</button>
                <button className="mode-btn" onclick="switchMode('batch')">Batch Inference</button>
            </div>

            {/* Single Inference Section */}
            <div id="single-section" className="inference-section active">
            ...
            <div id="batch-section" className="inference-section">
